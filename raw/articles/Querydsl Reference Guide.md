---
source_type: "article"
title: "Querydsl Reference Guide"
url: "http://querydsl.com/static/querydsl/5.0.0/reference/html_single/#intro"
author:
site: "querydsl.com"
published:
clipped: 2026-06-02
...
This copyrighted material is made available to anyone wishing to use, modify, copy, or redistribute it subject to the terms and conditions of the [Apache License, Version 2.0](http://www.apache.org/licenses/LICENSE-2.0).
...
| generatedAnnotationClass | The fully qualified class name of the *Single-Element Annotation* (with String element) to be added on the generated sources. Build in *com.querydsl.core.annotations.Generated* has CLASS retention which can be used for byte code analysis tools like Jacoco. (default: *javax.annotation.Generated* or *javax.annotation.processing.Generated* depending on the java version). See also [Single-Element Annotation](https://docs.oracle.com/javase/specs/jls/se8/html/jls-9.html#jls-9.7.3) |
...
![](http://querydsl.com/static/querydsl/5.0.0/reference/html_single/media/spatial.svg)
...
#### 2.4.4.4. Access to the SPATIAL\_REF\_SYS table

Unified access to the SPATIAL\_REF\_SYS standard table is provided via the QSpatialRefSys and SpatialRefSys classes. SPATIAL\_REF\_SYS contains data about the supported spatial reference systems.
...
See [Querying JPA/Hibernate sources](#jpa_integration "2.1. Querying JPA") for instructions on how to create query types.
...
For general usage instructions see [Querying Lucene sources](#lucene_integration "2.5. Querying Lucene").
...
| querydsl.generatedAnnotationClass | The fully qualified class name of the *Single-Element Annotation* (with String element) to be added on the generated sources. Build in *com.querydsl.core.annotations.Generated* has CLASS retention which can be used for byte code analysis tools like Jacoco. (default: *javax.annotation.Generated* or *javax.annotation.processing.Generated* depending on the java version). See also [Single-Element Annotation](https://docs.oracle.com/javase/specs/jls/se8/html/jls-9.html#jls-9.7.3) |
...
queryDSL을 사용하여 Spring 프로젝트 실습을 수행해야 하는데, 어떻게 쓰는지를 몰라서 사용법을 익히기 위해 추가함. queryDSL이 어떤 도구인지, 어떻게 써야하는지 전반적인 내용을 알고 싶음.